...
public class XmlDataBuilderTest {
    ...
    @Test
    public void ルートタグの任意の属性の値がnullの場合エラーとなること() throws Exception {
        createFormatFile(
                "UTF-8",
                "[data]",
                "1 @name X",
    ...
    @Test
    public void ルートタグの任意の属性名がnullの場合はスキップされること() throws Exception {
        createFormatFile(
                "UTF-8",
                "[data]",
                "1 @name X",
        ...
        assertThat(actual.toString("utf-8"),
                isIdenticalTo("<?xml version=\"1.0\" encoding=\"UTF-8\"?><data name=\"属性\" age=\"20\"></data>"));
    }
    ...
    @Test
    public void コンテンツ名が空の場合コンテンツ部が空で出力されること() throws Exception {
        sut.setContentName("");
    ...
    @Test
    public void 変更したコンテンツ名の値が指定されなかった場合空で出力されること() throws Exception {
        sut.setContentName("test");
    ...
    @Test
    public void ルートに任意の属性とコンテンツの組み合わせがあって属性がnullの場合エラーとなること() throws Exception {
        createFormatFile(
                "UTF-8",
                "[root]",
                "1 @attr [0..1] X",
    ...
    @Test
    public void 子要素の任意属性がnullの場合エラーとなること() throws Exception {
        createFormatFile(
                "UTF-8",
                "[root]",
                "1 child [0..1] OB",
    ...
    @Test
    public void 任意の子要素の配列がnullでも出力出来ること() throws Exception {
        createFormatFile(
                "UTF-8",
                "[parent]",
                "1 children [0..2] X"
    ...
    @Test
    public void 子要素の配列の長さが指定した範囲より大きい場合エラーとなること() throws Exception {
        createFormatFile(
                "UTF-8",
                "[parent]",
                "1 children [0..2] X"
    ...
    @Test
    public void 配列の任意子要素がnullの場合出力できること() throws Exception {
        createFormatFile(
                "UTF-8",
                "[parent]",
                "1 child [1..10] OB",
    ...
    @Test
    public void 属性を持つ要素の任意子要素の配列がnullの場合エラーとなること() throws Exception {
        createFormatFile(
                "UTF-8",
                "[parent]",
                "1 @attr X",
    ...
    @Test
    public void 属性を持つ要素の必須子要素の配列がnullの場合エラーとなること() throws Exception {
        createFormatFile(
                "UTF-8",
                "[parent]",
                "1 @attr X",
    ...
    @Test
    public void 属性を持つ要素の必須配列子要素がnullの場合でも出力できること() throws Exception {
        createFormatFile(
                "UTF-8",
                "[parent]",
                "1 @attr X",
